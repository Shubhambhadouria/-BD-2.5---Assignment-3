...
function sortByPriceoHighToLow(hotel1, hotel2){
...
app.get("/hotels/sort/pricing", (req,res)=>{
  ...
  if(pricing === "high-to-low"){
    result.sort(sortByPriceoHighToLow)
  }
...
function sortByRatingoHighToLow(hotel1, hotel2){
...
app.get("/hotels/sort/rating", (req,res)=>{
  ...
  if(rating === "high-to-low"){
    result.sort(sortByRatingoHighToLow)
  }
  res.json({ hotels: result });
})
...
function sortByReviewMostToLeast(hotel1, hotel2){
...
app.get("/hotels/sort/reviews", (req,res)=>{
  ...
  if(reviews === "least-to-most"){
    result.sort(sortByReviewsLeastToMost)
  }
  if(reviews === "most-to-least"){
    result.sort(sortByReviewMostToLeast)
  }
  res.json({ hotels: result });
})
